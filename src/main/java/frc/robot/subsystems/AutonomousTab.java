...
public class AutonomousTab extends SubsystemBase {
    ...
    protected static class Data {
        ...
        public TargetRotation targetRotation = TargetRotation.k3;
    }
    ...
    private void createOrderOfOperationsBox() {
        ...
        // put the widget on the Shuffleboard
        autonomousTab.add(orderOfOperationsBox).withWidget(BuiltInWidgets.kSplitButtonChooser).withPosition(9, 0)
                .withSize(8, 2);
    }
    ...
    private void createShootPowerCellBox() {
        ...
        // put the widget on the shuffleboard
        autonomousTab.add(shootPowerCellBox).withWidget(BuiltInWidgets.kSplitButtonChooser).withPosition(1, 3)
                .withSize(4, 2);
    }
    ...
    private void createShootDelayBox() {
        ...
        // put the widget on the shuffleboard
        autonomousTab.add(shootDelayBox).withWidget(BuiltInWidgets.kSplitButtonChooser).withPosition(6, 3).withSize(6,
                2);
    }
    ...
    private void createMoveOffLineBox() {
        ...
        // put the widget on the shuffleboard
        autonomousTab.add(moveOffLineBox).withWidget(BuiltInWidgets.kSplitButtonChooser).withPosition(1, 6).withSize(4,
                2);
    }
    ...
    private void createMoveDelayBox() {
        ...
        // put the widget on the shuffleboard
        autonomousTab.add(moveDelayBox).withWidget(BuiltInWidgets.kSplitButtonChooser).withPosition(6, 6).withSize(6,
                2);
    }
    ...
    private void createDirectionToMoveBox() {
        ...
        // put the widget on the shuffleboard
        autonomousTab.add(directionToMoveBox).withWidget(BuiltInWidgets.kSplitButtonChooser).withPosition(13, 6)
                .withSize(8, 2);
    }
    ...
    private void createPickUpPowerCellBox() {
        ...
        // put the widget on the shuffleboard
        autonomousTab.add(pickUpPowerCellBox).withWidget(BuiltInWidgets.kSplitButtonChooser).withPosition(1, 9)
                .withSize(4, 2);
    }
    ...
    private void createPickUpLocationBox() {
        ...
        // put the widget on the shuffleboard
        autonomousTab.add(pickUpLocationBox).withWidget(BuiltInWidgets.kSplitButtonChooser).withPosition(6, 9)
                .withSize(6, 2);
    }
    ...
    private void createShootNewPowerCellBox() {
        ...
        // put the widget on the shuffleboard
        autonomousTab.add(shootNewPowerCellBox).withWidget(BuiltInWidgets.kSplitButtonChooser).withPosition(13, 9)
                .withSize(8, 2);
    }
    ...
    private void createTargetColorBox() {
        ...
        // put the widget on the shuffleboard
        autonomousTab.add(targetColorBox).withWidget(BuiltInWidgets.kComboBoxChooser).withPosition(23, 11).withSize(2,
                2);
    }
    ...
    private void createSendDataButton() {
        ...
        autonomousTab.add(sendDataButton).withWidget(BuiltInWidgets.kSplitButtonChooser).withPosition(23, 1).withSize(4,
                2);
    }
    ...
    private boolean isDataValid() {
        ...
        if (startingLocationLeft && pickUpLocation) {
            ...
            DriverStation.reportWarning(
                    "Advised not to start Left with Pick Up Location: Trench.\n Potential crossover collision.", false);
        }
        ...
        if (startingLocationRight && !pickUpLocation) {
            isValid = false;
            DriverStation.reportWarning(
                    "Advised not to start Right with Pick Up Location: Rendezvous Point.\n Potential crossover collision",
                    false);
